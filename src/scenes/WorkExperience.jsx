          ...
          <div className="px-0 md:px-10">
            ...
            <ul className="list-disc space-y-4 ml-5 font-Lora overflow-y-auto max-h-60 px-[16px] scrollbar-thin scrollbar-track-[#A8A8A8]/20 scrollbar-thumb-[#022d5f]/80">
              ...
              <li>
                ...
                their content effectively without extensive technical knowledge.
              </li>
              <li>
        ...
        >
          ...
          <div className="px-0 md:px-10">
            ...
            <div className="flex space-x-2 mt-8 mb-2">
              ...
              <img className="h-10 w-10 object-contain" src={images.android} />
              <img className="h-10 w-10 " src={images.css3} />
            </div>
            <p className="uppercase py-5 text-black-300">Sep,2021 - Mar,2022</p>

            <ul className="list-disc space-y-4 ml-5 font-Lora  overflow-y-auto max-h-60 px-[16px] scrollbar-thin scrollbar-track-[#A8A8A8]/20 scrollbar-thumb-[#022d5f]/80">
              <li>
                Built a fully Responsive Mentum Products branding website using
              ...
              <li>
                Fixed existing defects and refactor the code base to improve the
                code base, optimized the codebase, and increased the application
                loading speed by 15%.
              </li>
              <li>
          ...
          <div className="px-0 md:px-10">
            ...
            <ul className="list-disc space-y-4 ml-5 font-Lora  overflow-y-auto max-h-60 px-[16px] scrollbar-thin scrollbar-track-[#A8A8A8]/20 scrollbar-thumb-[#022d5f]/80">
              <li>
                ...
                datasets via Google Cloud Platform using BigQuery, resulting in
                a 94.8% reduction in data discrepancies.
              </li>
              <li>
                Conducted data cleaning techniques on the housing dataset,
                including data deduplication, missing value imputation, and
                outlier detection, resulting in improved overall data quality by
                80%.
              </li>
              <li>
                Conducted data cleaning techniques on the housing dataset,
              ...
              <li>
                ...
                using Python to define the key metrics from 50+ housing features
                for a price prediction model.
              </li>
            </ul>
          </div>
        </article>
